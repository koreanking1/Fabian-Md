...
const botname = process.env.BOTNAME || 'Fabian-Md';
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'France King';
    const packname = process.env.STICKER_PACKNAME || 'Fabian-Md';
...
const admin = process.env.ADMIN_MSG || '𝐅𝐚𝐢𝐥𝐮𝐫𝐞!, 𝐘𝐨𝐮 𝐚𝐫𝐞 𝐭𝐨𝐨 𝐲𝐨𝐮𝐧𝐠 𝐭𝐨 𝐝𝐨 𝐭𝐡𝐚𝐭🐐';
    ...
    const botAdmin = process.env.BOT_ADMIN_MSG || 'The 11th commandment>You should Respect France King, The Greatest Of All Time🐐'
    const NotOwner = process.env.NOT_OWNER_MSG || 'Lol you are not France King🐐';
...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/85ae2999b0b09c52d3bdc.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./fabian.jpg'),
                                sourceUrl: 'https://wa.me/254757835036?text=ʜᴇʟʟᴏ+France_King +Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
function _0x2de4() {
    const _0xca7309 = [
        ...
        'catch',
        'e\x20text.\x20Th',
        '\x20of\x20its developer France King',
        'is\x20AI\x20work',
        '1832596QZCVhJ',
        '\x20and\x20Googl',
        'AgaVJ',
...
let xf = m.quoted.text;
                ...
                let pppuser = await client.profilePictureUrl(m.sender, 'image').catch(_ => 'https://telegra.ph/file/85ae2999b0b09c52d3bdc.jpg')
...
await m.reply('Successfully removed!'); 
 ...
 client.sendMessage(m.chat, { image: { url: `https://telegra.ph/file/85ae2999b0b09c52d3bdc.jpg` }, caption: 
`👋🏻 Hi *${pushname}*,You can deploy Fabian-Md using the GitHub link below🐐\n\nFork and give us a star✨.\n\n https://github.com/franceking1/Fabian-Md\n\nLink with your whatsapp using pairing link below\nhttps://replit.com/@franceking1/Pairing-Fabian-Md\n\nEnjoy and have fun with The Fabian-Md..\n\nMade on Earth by France King®🐐!!` });
...
try {
  ...
  let encmediax = await client.sendImageAsSticker(m.chat, mediax, m, { packname: Fabian-Md, author: France King });
  ...
  let encmediaxx = await client.sendVideoAsSticker(m.chat, mediaxx, m, { packname: Fabian-Md, author: France King });
...
case 'ytsearch':
    case 'yts': {
        if (!text) {
            reply('Provide a search term!\E.g: Rap god Eminem')
            return;
        }
        const term = text;
        const {
        ...
        try {
            ...
            if (fileSizeInMegabytes <= 100) {
                client.sendMessage(
                    from, {
                        video: fs.readFileSync(`./${randomName}`),
                        caption: `𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 Fabian-Md`,
                    }, {
                        quoted: m
                    }
                );
...
case "alive": { 
 ...
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/70cf1d31045b44e7d4ab1.jpg' }, caption: `Hello ${m.pushName}, Fabian-Md is alive since  ${runtime(process.uptime())}`, fileLength: "9999999999898989899999999" }, { quoted: m }); 
 }
break;
case 'apk': {
...
case "movie": 
 ...
 break;
      ...
      case "Fabian": case "owner": case "FranceKing": 
 client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/70cf1d31045b44e7d4ab1.jpg' }, caption: `Say no more 😌 here is the contact of France King +254757835036 🐐` }, {quoted: m}); 
 ...
 break;
        ...
        case "gpt": case "g": 
            ...
            if (!text) return reply("Hello am Fabian-Md, an Ai developed by France King. how can I help you today?");
